# %%writefile week_3_practice/model_building/prep.py
...
DATASET_PATH = "hf://datasets/Jyant/play-store-revenue-analysis/playstore_revenue_analysis.csv"
...
for file_path in files:
    api.upload_file(
        ...
        repo_id="Jyant/play-store-revenue-analysis",
        repo_type="dataset",
    )
